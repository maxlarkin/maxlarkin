### Ларкин Максим
## Обо мне 📋:
- Являюсь студентом ИРИТ-РТФ на АИИ направлении
...
| Пятница | занятия |
| Суббота | Прохождение курсов |
| Воскресенье | Святое ничегонеделание |

Ссылка на мой гит (не знаю зачем, но пусть будет 😐): https://github.com/maxlarkin

Давно слеланный через одно место и на коленке сайт (год два назад):
